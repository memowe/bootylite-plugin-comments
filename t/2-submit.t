...
is($cc->text, 'Comments: 0', 'right comment count');
$cc = $t->tx->res->dom->at('.article:nth-child(2) .comment_count a');
...
)->status_is(302)->header_like('Location', qr|/articles/test7#comments$|);
